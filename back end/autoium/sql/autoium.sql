...
CREATE TABLE `api_case` (
	...
	`host` VARCHAR ( 255 ) DEFAULT '' CHARACTER SET utf8 COMMENT '协议和域名',
	`path` VARCHAR ( 255 ) DEFAULT '' CHARACTER SET utf8 COMMENT '路径',
	...
	`req_body_file` VARCHAR ( 255 ) DEFAULT '' CHARACTER SET utf8 COMMENT '用例的文件类型请求体,用阿里OSS存储',
